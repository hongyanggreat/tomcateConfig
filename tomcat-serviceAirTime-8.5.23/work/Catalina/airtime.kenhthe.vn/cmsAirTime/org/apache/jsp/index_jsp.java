...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/common.jsp", Long.valueOf(1509441451000L));
    _jspx_dependants.put("/includes/topFooter.jsp", Long.valueOf(1509441457000L));
    _jspx_dependants.put("/includes/head.jsp", Long.valueOf(1509441457000L));
    _jspx_dependants.put("/includes/topMenu.jsp", Long.valueOf(1509441458000L));
    _jspx_dependants.put("/includes/mainMenu.jsp", Long.valueOf(1509441457000L));
    _jspx_dependants.put("/includes/footerJs.jsp", Long.valueOf(1509441457000L));
  }
  ...
  //       
    ...
    if (!Tool.checkNull(session.getAttribute("acc"))) {
      ...
      out.write("    <head>\n");
      out.write("        <title>Maruti Admin</title>\n");
      ...
      out.write("        <link rel=\"stylesheet\" href=\"");
      out.print( baseUrl);
      out.write("/resource/css/maruti-style.css\" />\n");
      out.write("        <link rel=\"stylesheet\" href=\"");
      out.print( baseUrl);
    ...
    String moduleSourse  = "AirTime";
      ...
      out.write("        <li class=\"\" >\n");
      out.write("            <a title=\"\" href=\"#\"><i class=\"icon icon-user\"></i> \n");
      ...
      out.write("                <li><a class=\"sAdd\" title=\"\" href=\"#\">new message</a></li>\n");
      out.write("                <li><a class=\"sInbox\" title=\"\" href=\"#\">inbox</a></li>\n");
      out.write("                <li><a class=\"sOutbox\" title=\"\" href=\"#\">outbox</a></li>\n");
      out.write("                <li><a class=\"sTrash\" title=\"\" href=\"#\">trash</a></li>\n");
      out.write("            </ul>\n");
      out.write("        </li>\n");
      ...
      out.write("    <button type=\"submit\" class=\"tip-left\" title=\"Search\"><i class=\"icon-search icon-white\"></i></button>\n");
      out.write("</div>\n");
      out.write("\n");
      out.write("\n");
...
//    checkErrorChargeAirTime = accountPermission.checkList(request, session, "errorChargeAirTime");
      ...
      out.print( baseUrl);
      out.write("\"><i class=\"icon icon-home\"></i> <span>Home</span></a> </li>\n");
      out.write("            ");
 if (checkAccounts || checkUserPermission) {
      out.write("\n");
      out.write("        <li class=\"submenu\"> <a href=\"#\"><i class=\"icon icon-th-list\"></i> <span>Quản lý Tài khoản</span> <span class=\"label label-important\">2</span></a>\n");
      out.write("            <ul>\n");
      out.write("                ");
 if (checkAccounts) {
      out.write("\n");
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/accounts\">Tài khoản</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("                    ");
 if (checkUserPermission) {
      ...
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/userPermission\">Phân quyền tài khoản</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("            </ul>\n");
 ...
 if (checkModules) {
      ...
      out.write("\n");
      out.write("            ");
 if (checkServices || checkAirtimeManager) {
      out.write("\n");
      out.write("        <li class=\"submenu\"> <a href=\"#\"><i class=\"icon icon-th-list\"></i> <span>Quản lý dịch vụ</span> <span class=\"label label-important\">2</span></a>\n");
      out.write("            <ul>\n");
      out.write("                ");
 if (checkServices) {
      out.write("\n");
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/services\">Dịch vụ</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("                    ");
 if (checkAirtimeManager) {
      ...
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/airtimeManager\">Đăng ký dịch vụ airtime</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("            </ul>\n");
 ...
 if (checkOtpAirTime || checkChargeAirTime || checkErrorOtpAirTime || checkErrorChargeAirTime) {
      out.write("\n");
      out.write("        <li class=\"submenu\"> <a href=\"#\"><i class=\"icon icon-th-list\"></i> <span>TK DV AirTime</span> <span class=\"label label-important\">4</span></a>\n");
      out.write("            <ul>\n");
      out.write("                ");
 if (checkOtpAirTime) {
      out.write("\n");
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/otpAirTime/statistic.jsp\">Thống kê OTP Success</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("                    ");
 if (checkChargeAirTime) {
      ...
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/chargeAirTime/statistic.jsp\">Thống kê Charge Success</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("                    ");
 if (checkErrorOtpAirTime) {
      ...
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/errorOtpAirTime/statistic.jsp\">Thống kê OTP Error</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("                    ");
 if (checkErrorChargeAirTime) {
      ...
      out.write("                <li><a href=\"");
      out.print( baseUrl);
      out.write("/errorChargeAirTime/statistic.jsp\">Thống kê Charge Error</a></li>\n");
      out.write("                    ");
}
      out.write("\n");
      out.write("            </ul>\n");
      ...
      out.write("<!DOCTYPE html>\n");
      out.write("<div class=\"row-fluid\">\n");
      out.write("    <div id=\"footer\" class=\"span12\">2017 &copy; HTC. Thiết kế bởi <a href=\"\">HTC Comporation</a> </div>\n");
      out.write("</div>");
      out.write('\n');
      out.write("    <script src =\"");
      out.print( baseUrl );
      ...
      out.write("    <script src =\"");
      out.print( baseUrl );
      out.write("/resource/js/bootstrap-datepicker.js?v=1.0\"></script> \n");
      out.write("    <script src =\"");
      out.print( baseUrl );
      ...
      out.write("    <script src =\"");
      out.print( baseUrl );
      out.write("/resource/js/jquery.dataTables.min.js\"></script> \n");
      out.write("</body>\n");
      out.write("</html>\n");
      out.write('\n');
